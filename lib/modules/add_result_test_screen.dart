...
class AddResultTestScreen extends StatefulWidget {
  const AddResultTestScreen({super.key, required this.id});

  final int id ;

  @override
  State<AddResultTestScreen> createState() => _AddResultTestScreenState();
}

class _AddResultTestScreenState extends State<AddResultTestScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(child: Text('اضافة رد' , style: TextStyle(fontFamily: 'RobotoCondensed'),)),
        toolbarHeight: 82.62,
              ...
              builder: (context, state) {
                return ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    await BlocProvider.of<addradiographCubit>(context).cc2(
                      askRadiographs.text,
                      widget.id
                    );
                  },
