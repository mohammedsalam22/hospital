...
class getsummarychargeItem extends StatefulWidget {
  @override
  State<getsummarychargeItem> createState() => _getsummarychargeItemState();
}

class _getsummarychargeItemState extends State<getsummarychargeItem> {
  late final SummaryDischarge summaryDischarge;

  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      await BlocProvider.of<getsummarychargeCubit>(context).fetchgetsummarycharge();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('استمارات التخريج'),
      ),
      body:  BlocBuilder<getsummarychargeCubit, getsummarychargeState>(
